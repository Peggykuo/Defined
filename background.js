...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) =>{
    ...
    fetch(dictUrl)
      ...
      .then(data => {
        ...
        // Get first meaning, first definition
      ...
      .catch(dictError => {
        // TIER 3: Fall back to Wikipedia Page Summary API (for tech terms/names not in dictionary, e.g. "Kubernetes")
        ...
        fetch(wikiUrl)
          ...
          .catch(wikiError => {
            ...
            fetch(wikiRetryUrl)
              ...
              .catch(() => {
                sendResponse({ success: false, error: 'Definition not found in local database, dictionary, or Wikipedia.' });
              });
          });
      });
